...
public class App {
    ...
    static void mainMethod() {
        ...
        CourseImpl courseService = new CourseService();
        InstructorImpl instructorService = new InstructorService();
        LessonImpl lessonService = new LessonService();
        TaskImpl taskService = new TaskService();
                ...
                if (Character.isDigit(number.charAt(0))) {
                    switch (number) {
                        case "1" -> {
                            ...
                            course.setDuration(scanner11.nextLine());
                        ...
                        case "7" -> {
                            ...
                            instructor.setFirsName(scanner7.nextLine());
                        ...
                        case "13" -> {
                            ...
                            lessonService.saveLesson(id, new Lesson(name, video));
                        }
                        case "15" -> {
                        ...
                        case "16" -> {
                            ...
                            Long id = scanner.nextLong();
                            for (Lesson i : lessonService.getLessonsByCourseId(id)) {
                                System.out.println(i);
                            }
                        }
                        case "17" -> {
                            ...
                            taskService.saveTask(lessonId, new Task(name, deadLine, taskName));
                        }
                        case "18" -> {
